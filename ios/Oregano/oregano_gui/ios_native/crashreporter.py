...
from oregano import PACKAGE_VERSION
...
<ul>
  <li>Oregano version: {app_version}</li>
...
class CrashReporterVC(CrashReporterBase):
    ...
    def viewDidLoad(self) -> None:
        ...
        utils.uilabel_replace_attributed_text(self.errMsg,
                                               _('Sorry!')  + " " + _('Something went wrong running Oregano.') + " " + _('To help us diagnose and fix the problem, you can send us a bug report that contains useful debug information:').translate({ord(':'):None}),
