...
#
'''
    Monkey Patches -- mostly to modify oregano.* package to suit our needs.
    Don't hate me.  (This was needed to keep the iOS stuff self-contained.)
'''
from .uikit_bindings import *
from oregano.util import (InvalidPassword, profiler)
import oregano.bitcoin as ec_bitcoin
from oregano_gui.ios_native.utils import NSLog
import sys, ssl
