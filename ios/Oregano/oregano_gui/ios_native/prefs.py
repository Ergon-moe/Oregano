...
from oregano.util import timestamp_to_datetime, base_units, base_unit_labels
from oregano.i18n import _, language, pgettext
import time
import html
...
UNITS = base_units
UNIT_KEYS = base_unit_labels  # ('ERG', 'mERG', 'bits') in decreasing order
