...
from oregano.old_mnemonic import words as old_words
from typing import Any
from .uikit_bindings import *
from .custom_objc import *
import sys
from collections import namedtuple
import oregano.bitcoin as bitcoin
import oregano.keystore as keystore
...
if False:
    ...
    __DUMMY_FOR_TRANSLATION = (
        ...
        # On-Boarding text...
        _("Welcome to"), _("Oregano is an SPV wallet for Ergon"),
        ...
        for lbl in lbls:
            if lbl.ptr == self.info.ptr:
                if not self.restoreMode:
                    ...
                    txt = _('You can restore a wallet that was created by any version of Oregano.')
        ...
        if seed_type == 'bip39':
            ...
            alert = utils.show_tf_alert(vc = self,
                                        ...
                                        message = ' '.join([_('Enter your wallet derivation here.'),
                                                             ...
                                                             _("If you want the wallet to use Ergon addresses use m/44'/145'/0'")]),
...
class Import1(Import1Base):
    ...
    def viewDidLoad(self) -> None:
        ...
        if self.masterKeyMode:
            ...
            self.title = _("Import")
            titText = _("Import Ergon Addresses or Private Keys")
            infoText = _("Enter a list of private keys to create a regular spending wallet. " +
                         ...
                         "entering a list of Ergon addresses.")
        ...
        if self.masterKeyMode:
            ...
            for w in words:
                if Address.is_valid(w) or bitcoin.is_private_key(w):
                    ClearErrMsg()
                    return True
            ErrMsg( _("You appear to have entered no valid Ergon addresses or private keys.") )
        return False
...
class Import2(Import2Base):
    ...
    def tableView_cellForRowAtIndexPath_(self, tableView, indexPath):
        ...
        try:
            ...
            if ii.typ == 1:
                cell.desc.text = "Ergon Address" + (" (watching-only)" if k and k.is_watching_only() else "")
            elif ii.typ == 2:
        ...
        if self.masterKeyMode:
            ...
            if k:
                if k.is_watching_only():
                    ...
                    msg = _("A deterministic wallet will be created using the provided master private key. This wallet will be able to freely send and receive Ergon.")
            else:
                ret = False
