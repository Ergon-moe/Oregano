# Oregano Update Checker
### (`releases.json`)

This directory contains the `releases.json` file that the Oregano update checker uses to determine when a new version of Oregano is available.
...
It hopefully will decrease the number of users running very old versions of Oregano.

#### What This Means For You, The Maintainer
You need to update `releases.json` in this directory whenever a new version of Oregano is released, and push it to master.
...
-  Open up Oregano and go to that address in the "Addresses" tab and right click on it, selecting **"Sign/Verify Message"**
...
#### Feedback / Questions
Open up an issue in the issue tracker or contact Calin Culianu (/u/NilacTheGrim on reddit), as he is the author of this mechanism in Oregano.
