...
;Variables
  ...
  !define PRODUCT_WEB_SITE "https://github.com/Oregano/Oregano"
...
Section
  ...
  ;Links ergon: URI's to Oregano
  WriteRegStr HKCU "Software\Classes\ergon" "" "URL:ergon Protocol"
  WriteRegStr HKCU "Software\Classes\ergon" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\ergon" "DefaultIcon" "$\"$INSTDIR\electron.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\ergon\shell\open\command" "" "$\"$INSTDIR\${INTERNAL_NAME}.exe$\" $\"%1$\""
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\ergon"
