...
from oregano.util import bfh, bh2u, versiontuple, UserCancelled
from oregano.bitcoin import (b58_address_to_hash160, xpub_from_pubkey, deserialize_xpub,
                                  TYPE_ADDRESS, TYPE_SCRIPT)
from oregano.i18n import _
from oregano.networks import NetworkConstants
from oregano.plugins import BasePlugin, Device
from oregano.transaction import deserialize
from oregano.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
from oregano.address import ScriptOutput
...
class TrezorKeyStore(Hardware_KeyStore):
    ...
    def needs_prevtx(self):
        # Trezor does need previous transactions for Ergon
        return True
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_tx(self, tx_hash):
        # for oregano previous tx is never needed, since it uses
        # bip-143 signatures.
        return None
