...
# Part of the Oregano SPV Wallet
# License: MIT
import unittest
...
if False:
    ...
    imp.load_module('oregano', *imp.find_module('lib'))
    imp.load_module('oregano_gui', *imp.find_module('gui/qt'))
    imp.load_module('oregano_plugins', *imp.find_module('plugins'))
