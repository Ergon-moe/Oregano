...
from oregano.util import PrintError, UserCancelled
from oregano.keystore import bip39_normalize_passphrase
...
class KeepKeyClientBase(GuiMixin, PrintError):
    ...
    def has_usable_connection_with_device(self):
        try:
            res = self.ping("oregano pinging device") # FIXME: Add some randomness
            assert res == "oregano pinging device"
